...
<!--    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
  ...
  <a onclick="openForm()" class="button" style="float:right;width:150px;margin-right:20px;margin-top:25px">Create Meeting</a> 
<!--    <button class="header2button header2button-login" onclick="openForm()">Create Meeting</button> -->
...
<table align="center">
  ...
  <tr>
    ...
    <th style= "text-align:center" colspan="6">Meeting Notification</th>
...
$sql = "SELECT * FROM meetings where project_name ='".$error."'";
...
<td style='".$padding."'> ".$row["title"]."</td>
<td style='".$padding."'>".$row["description"]."</td>
<td style='".$padding."'>".$row["created_by"]."</td>
<td style='".$padding."'>".$row["time"]."</td>
<td style='".$padding."'>".$row["zoom_id"]."</td>
<td style='".$padding."'>".$row["zoom_pass"]."</td>
...
?>
    ...
    <script>
function openForm(){
        window.location = "http://localhost/agile/createmeeting.php?value=<?php echo $error ?>";
    }
    </script>
